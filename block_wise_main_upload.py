...
if __name__ == '__main__':
    ...
    parser.add_argument('--gpu', type=str, default='1', metavar='N')
    parser.add_argument('--log', type=str, default='log_1', metavar='N')
    parser.add_argument('--model_pth', type=str, default='model_1.pth', metavar='N')

    parser.add_argument('--batch_size', type=int, default=128)
    parser.add_argument('--meta_tasks_epochs', type=int, default=40, metavar='N')
    parser.add_argument('--unified_epoch', type=int, default=50, metavar='N')
    ...
    if 1:
        ...
        feature_video_train_200_9 = torch.load('path')
        feature_video_test_200_9 = torch.load('path')
    ...
    for zz in range(5):
        # generate mask data
        if 1:
            mask_train_200 = get_mask(4, tr200_len, args.missing_rate)
            mask_test_200 = get_mask(4, te200_len, args.missing_rate)

            feature_image_train_200_mask_9 = feature_image_train_200_9 * mask_train_200[0].unsqueeze(1).unsqueeze(1)
            feature_audio_train_200_mask_9 = feature_audio_train_200_9 * mask_train_200[1].unsqueeze(1).unsqueeze(1)
            feature_text_train_200_mask_9 = feature_text_train_200_9 * mask_train_200[2].unsqueeze(1).unsqueeze(1)
            feature_video_train_200_mask_9 = feature_video_train_200_9 * mask_train_200[3].unsqueeze(1).unsqueeze(1)

            feature_image_test_200_mask_9 = feature_image_test_200_9 * mask_test_200[0].unsqueeze(1).unsqueeze(1)
            feature_audio_test_200_mask_9 = feature_audio_test_200_9 * mask_test_200[1].unsqueeze(1).unsqueeze(1)
            feature_text_test_200_mask_9 = feature_text_test_200_9 * mask_test_200[2].unsqueeze(1).unsqueeze(1)
            feature_video_test_200_mask_9 = feature_video_test_200_9 * mask_test_200[3].unsqueeze(1).unsqueeze(1)

            feature_image_train_200_mask = feature_image_train_200 * mask_train_200[0].reshape(tr200_len, 1)
            feature_audio_train_200_mask = feature_audio_train_200 * mask_train_200[1].reshape(tr200_len, 1)
            feature_text_train_200_mask = feature_text_train_200 * mask_train_200[2].reshape(tr200_len, 1)
            feature_video_train_200_mask = feature_video_train_200 * mask_train_200[3].reshape(tr200_len, 1)

            feature_image_test_200_mask = feature_image_test_200 * mask_test_200[0].reshape(te200_len, 1)
            feature_audio_test_200_mask = feature_audio_test_200 * mask_test_200[1].reshape(te200_len, 1)
            feature_text_test_200_mask = feature_text_test_200 * mask_test_200[2].reshape(te200_len, 1)
            feature_video_test_200_mask = feature_video_test_200 * mask_test_200[3].reshape(te200_len, 1)
